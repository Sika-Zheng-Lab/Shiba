...
# Shiba (v0.7.0) <img src="https://raw.githubusercontent.com/Sika-Zheng-Lab/Shiba/main/img/Shiba_icon.png" width=40% align="right">
...
```bash
docker pull naotokubota/shiba:v0.7.0
```
